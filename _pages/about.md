...
我是**杭州电子科技大学自动化（人工智能）学院控制工程专业**的硕士研究生，导师为**高云园教授**，研究方向为多模态时序信号建模与解码。作为**学生作者**参与多篇 EEG 解码相关论文（**1 篇已发表 + 6 篇在审**），核心创新如下（点击可跳转至[论文页面](/publications/)）：
...
- [**PhysioSync**](/publications/#gao2026physiosync) · *IEEE T-AFFC*（IF≈9.8 · JCR Q1 · 中科院计算机 1区 TOP；第二作者（导师一作），大修已返修）：面向**连续情绪回归**，在多模态融合**之前**先做 **HRF 式神经血管对齐**（可学习双伽马核），并把对齐残差转化为**可靠性门控**抑制不可靠的血流动力学证据，配合线性复杂度 Mamba 编码长程 EEG。
- [**PSSF**](/publications/#hu2026pssf) · *Journal of Neural Engineering*（IF≈4.0 · JCR Q2；第二作者，初审中）：提出**相空间与状态空间融合**方法，以 sLORETA 源定位、时延嵌入相空间重构与混合熵刻画非线性源动力学，并用状态空间稀疏估计筛选活跃 ROI，在 MI 与 ADHD 任务上提升特征可分性。
...
- [**MSPhys-Diff**](/publications/#gao2027msphysdiff) · *AAAI-27*（第三作者，投稿在审，Submission 46558）：研究融合多尺度生理先验的扩散模型，用于帕金森病 EEG 生成。

此外，作为**第一发明人**申请发明专利一项（神经血管耦合对齐与残差可靠性融合的脑电近红外情绪回归方法），并拥有软件著作权一项（大宗商品 AI 分析系统 V1.0，登记号 2026SR0328287）。详见[简历](/cv/)。
