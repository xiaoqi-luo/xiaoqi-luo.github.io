...
- [**PCMAN**](/publications/#gao2026pcman) · *Applied Soft Computing*（IF≈6.6 · JCR Q1 · 中科院计算机 2区 TOP；第二作者（导师一作），已发表）：提出**渐进式跨模态对齐网络**，以"物理 → 语义 → 任务"三层渐进机制融合 EEG 与 fNIRS——用滑动窗口建模血流动力学延迟、以 fNIRS 空间注意力增强 EEG，系统性缓解两种信号的时空异质性。
...
- [**Neuro-SSCL**](/publications/#lu2026neurosscl) · *IEEE JBHI*（IF≈6.8 · JCR Q1 · 中科院医学 2区；第二作者，初审中）：将**神经科学先验**（容积传导的局部空间相关 + 全局功能连接拓扑）注入**半监督对比学习**，并以谱自适应多尺度图对比与多域自适应，缓解跨被试 EEG 情绪识别的**标签稀缺**问题。
